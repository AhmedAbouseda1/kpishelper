...
describe('Library e2e test', () => {
  ...
  const librarySample = { name: 'yet denitrify' };
  ...
  describe('new Library page', () => {
    ...
    it('should create an instance of Library', () => {
      cy.get(`[data-cy="name"]`).type('brand');
      cy.get(`[data-cy="name"]`).should('have.value', 'brand');

      cy.get(`[data-cy="location"]`).type('regarding as total');
      cy.get(`[data-cy="location"]`).should('have.value', 'regarding as total');
