...
describe('Population e2e test', () => {
  ...
  const populationSample = { date_recorded: '2024-04-22', population: 5455 };
  ...
  describe('new Population page', () => {
    ...
    it('should create an instance of Population', () => {
      ...
      cy.get(`[data-cy="population"]`).type('2213');
      cy.get(`[data-cy="population"]`).should('have.value', '2213');

      cy.get(`[data-cy="active_members"]`).type('21618');
      cy.get(`[data-cy="active_members"]`).should('have.value', '21618');
