...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './electronic-services.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ELECTRONICSERVICES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ELECTRONICSERVICES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ELECTRONICSERVICES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ELECTRONICSERVICES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ELECTRONICSERVICES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ELECTRONICSERVICES actions', async () => {
      const arg = 42666;
