  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="kpishelperApp.library.home.createOrEditLabel" data-cy="LibraryCreateUpdateHeading">
            <Translate contentKey="kpishelperApp.library.home.createOrEditLabel">Create or edit a Library</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('kpishelperApp.library.name')}
                id="library-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('kpishelperApp.library.location')}
                id="library-location"
                name="location"
                data-cy="location"
                type="text"
