...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './space.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPACE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPACE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPACE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_SPACE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_SPACE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPACE actions', async () => {
      const arg = 42666;
