...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './visitors.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VISITORS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VISITORS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VISITORS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VISITORS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VISITORS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VISITORS actions', async () => {
      const arg = 42666;
