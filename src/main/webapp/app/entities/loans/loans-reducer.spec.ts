...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './loans.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOANS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOANS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOANS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LOANS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LOANS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOANS actions', async () => {
      const arg = 42666;
