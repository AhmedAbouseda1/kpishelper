...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITIES_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVITIES actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVITIES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVITIES actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITIES actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVITIES actions', async () => {
      const arg = 42666;
