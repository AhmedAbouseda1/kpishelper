...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './training.reducer';
...
describe('Entities reducer tests', () => {
  ...
  const initialState: EntityState<ITraining> = {
    loading: false,
    errorMessage: null,
    entities: [],
    entity: defaultValue,
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAINING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRAINING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRAINING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRAINING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRAINING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRAINING actions', async () => {
      const arg = 42666;
