...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POPULATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POPULATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POPULATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POPULATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POPULATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POPULATION actions', async () => {
      const arg = 42666;
