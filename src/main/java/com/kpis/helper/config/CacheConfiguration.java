...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.kpis.helper.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.kpis.helper.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            createCache(cm, com.kpis.helper.domain.User.class.getName());
            createCache(cm, com.kpis.helper.domain.Authority.class.getName());
